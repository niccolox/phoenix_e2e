defmodule PhoenixE2eWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PhoenixE2eWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PhoenixE2eWeb.Gettext, "errors", msg, opts)
    end
  end
