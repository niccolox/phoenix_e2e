...
var AutomationRunSubmitThreadCommand = /** @class */ (function (_super) {
    ...
    AutomationRunSubmitThreadCommand.prototype.buildCommand = function () {
        ...
        command.option('--results-rewriter <file>', 'An optional JavaScript file to rewrite & transform tests before sending them to Testmo');
        ...
        command.option('--proxy <address>', 'An optional HTTP(S) proxy server to use for all connections and API requests');
        return command;
    };
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, controller.run({
                                ...
                                resultRewriterFile: this.trimOptionalArgument(commandOptions.resultsRewriter),
                                ...
                                proxy: this.trimOptionalArgument(commandOptions.proxy),
                                ...
                                onAfterCollect: function (fileCount, results) {
                                    if (fileCount > 0) {
                                        ...
                                        logger_1.logger.warn('Warning: Could not find any valid result files or tests');
                                        logger_1.logger.warn('Please review the --results option and specify one or more result files');
                                        logger_1.logger.warn('Ensure the files have an expected file extension (.xml) and format');
                                    }
                                },
