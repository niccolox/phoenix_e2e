            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, api.createAutomationRun(parseInt(options.projectId, 10), remote_1.RemoteAutomationRunCreate.fromOptions(options, resources))];
                    case 3:
                        remoteRun = _a.sent();
                        ...
                        return [4 /*yield*/, api.createAutomationRunThread(remoteRun.id, remote_1.RemoteAutomationThreadCreate.fromOptions(threadOptions))];
                    case 4:
                    ...
                    case 8:
                        ...
                        // Complete the run
                        return [4 /*yield*/, api.completeAutomationRun(remoteRun.id, remote_1.RemoteAutomationRunComplete.fromOptions({
