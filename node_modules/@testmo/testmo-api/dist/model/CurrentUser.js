...
var CurrentUser = /*#__PURE__*/function () {
  ...
  _createClass(CurrentUser, null, [{
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('time_format')) {
          obj['time_format'] = _ApiClient["default"].convertToType(data['time_format'], 'String');
        }
      }
      return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CurrentUser</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CurrentUser</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      ...
      // ensure the json data is a string
      if (data['date_format'] && !(typeof data['date_format'] === 'string' || data['date_format'] instanceof String)) {
        throw new Error("Expected the field `date_format` to be a primitive type in the JSON string but got " + data['date_format']);
      }
      // ensure the json data is a string
      if (data['time_format'] && !(typeof data['time_format'] === 'string' || data['time_format'] instanceof String)) {
        throw new Error("Expected the field `time_format` to be a primitive type in the JSON string but got " + data['time_format']);
      }
      return true;
    }
  }]);
 ...
 */
CurrentUser.prototype['timezone'] = undefined;

/**
 * @member {String} date_format
 */
CurrentUser.prototype['date_format'] = undefined;

/**
 * @member {String} time_format
 */
CurrentUser.prototype['time_format'] = undefined;
